...
Plus/minus (+/-) is a statistic that gives insight about how defensively responsible a player is. A player's plus/minus increases if they are on the ice when their team scores a goal, and it decreases if they are on the ice when a goal is scored against their team. The median plus/minus for all positions is roughly the same, showing that defensemen can easily match the skill levels of forwards.
